...
\begin{frame}[shrink]{Bản đồ phát triển}
    \begin{figure}[H]
        \centering
...
\begin{frame}[shrink]{Chia topology Decartes}
    \begin{itemize}
...
\begin{frame}[shrink, fragile]{Topology đồ thị}
    \begin{verbatim}
int rank, size;
int nnodes = 4;
int index[4] = {2, 2, 2, 2};
...
\begin{frame}[shrink]{Thiết kế của GPU}
    \begin{itemize}
...
\begin{frame}[shrink, fragile]{Biên dịch và chạy chương trình CUDA}
    \begin{itemize}
...
\begin{frame}[shrink]{Mô hình thực thi trên GPU}
    \begin{columns}[onlytextwidth]
        \begin{column}{0.5\linewidth}
            \begin{itemize}
